...
static char col_hover_dark_blue[] =
    "#578BC9"; /*focused instantmenu or topbar d */
...
static char col_hover_dark_red[] =
    "#CE577C"; /*focused instantmenu or topbar d */
...
static const char *colors[][4] = {
    ...
    [SchemeAddActive] = {col_white, col_orange, col_light_blue,
                         col_dark_orange},
...
static const char *caretinstantswitchcmd[] = {
    ...
    "MousePrimary",
    "-theme",
    "/usr/share/instantdotfiles/rofi/appmenu.rasi",
    NULL};
